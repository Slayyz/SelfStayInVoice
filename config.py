...
class Default_token_config(Token_config):
    __instance = None
    guild_id = cfg['default']['guild_id']
    channel_id = cfg['default']['channel_id']
    self_mute = cfg['default']['self_mute']
    self_deaf = cfg['default']['self_deaf']
